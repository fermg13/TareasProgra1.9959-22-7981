...
// Programacion 1
// Tercer semestre
// Programa con Encabezado
// Programa para gestionar ligas de deporte
...
void imprimirMatrizLSegunda(float segundaMatriz[NUMERO_EQUIPOS+1][NUMERO_ACTIVIDADES+1])
{
    cout << endl << "\t\t\t\tLIGA SEGUNDA DIVISION\n" << endl;
    imprimirLineaMatriz();
    cout << setw(20) << "EQUIPO" << setw(10) << "|" << setw(5);
...
void promedioMayorSegunda ()
{
    ...
    cout << "\t\tPromedio mayor de Liga Segunda Division : " << fixed << setprecision(2) << mayor2 << endl;
}
void promedioGeneralPorLigas()
{
    ...
    cout << "\t\tPromedio General Liga de Ascenso: " << fixed << setprecision(2) << promedioGeneralAsc << endl;
    cout << "\t\tPromedio General Liga Segunda Division: " << fixed << setprecision(2) << promedioGeneralSeg << endl;
}
void impresionResultadosLigas()
{
    ...
    {
        cout << "\n\t\tLa liga ganadora es: Segunda Division con " << mayor2 << endl;
    }
}
void promedioGeneralLigas()
{
